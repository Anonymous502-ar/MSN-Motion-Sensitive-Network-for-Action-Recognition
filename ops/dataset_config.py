...
def return_something(modality):
    ...
    if modality == 'RGB' or modality == 'RGBDiff':
        root_data = "/" 
        filename_imglist_train = "/your_path_to/20bn-something-something-v1/train_videofolder.txt"
        filename_imglist_val = "/your_path_to/20bn-something-something-v1/val_videofolder.txt"
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
...
def return_somethingv2(modality):
    ...
    if modality == 'RGB':
        root_data = "/"
        filename_imglist_train = "/your_path_to/ssv2/train_videofolder.txt"
        filename_imglist_val = "/your_path_to/ssv2/val_videofolder.txt"
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        root_data = r"/your_path_to/kintics"
        filename_imglist_train = r"/your_path_to/kintics/train.csv"
        filename_imglist_val = r"/your_path_to/kintics/val.csv"
        prefix = 'image_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
