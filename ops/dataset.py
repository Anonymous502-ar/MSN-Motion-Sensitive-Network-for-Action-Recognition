...
class TSNDataSet(data.Dataset):
    def __init__(self, dataset, root_path, list_file,
                 ...
                 remove_missing=False, dense_sample=False, twice_sample=False, testtransform=None):
    ...
    def __getitem__(self, index):
        ...
        if ('something' in self.dataset):
            ...
            try:
                ...
                print(video_path)
                path = r'E:/work/Dataset/action_recognition/compress/train_256/playing_drums/InHPFq1PrlY_000018_000028.mp4'
                video_list = decord.VideoReader(path)
    ...
    def get(self, record, video_list, indices, decode_boo):
        ...
        test_data, test_record_label = self.testtransform((images, record.label))
        # print(type(test_data))
        return process_data, record_label, test_data
